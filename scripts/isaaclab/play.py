...
def main(
    ...
    if args_cli.video:
        ...
        video_kwargs = {
            "video_folder": os.path.join("runs", "videos", f"{task_name}_policyflow"),
    ...
    model_path = os.path.join(
        current_path,
        "../..",
        "runs_pf/Franka_policyflow/25-09-27_17-09-46-827931/model_7000.pt",
    )
    runner.load(model_path)
    runner.evaluate(steps=1000, return_epochs=100)
